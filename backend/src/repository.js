...
export const repository={
 ...
 async clearFeedback(roundId){const x=await query(`UPDATE round_runtime_state SET feedback='[]'::jsonb,revision=revision+1,updated_at=now() WHERE round_id=$1 RETURNING revision`,[roundId]);return x.rows[0]||{revision:0}},
